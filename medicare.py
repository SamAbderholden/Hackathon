...
def get_data(location):
    ...
    headers = {
        ...
        'Referer':'https://www.medicare.gov/care-compare/results/?searchType=Hospital&page=1&city=&state=&zipcode=&radius=25&emergencyServices=true&sort=closest&tealiumEventAction=Landing%20Page%20-%20Search&tealiumSearchLocation=search%20bar%20-%20suggested%20search%20result',
        }
    payload = {
        "type":"Hospital",
